...
CREATE TABLE `users` (
  ...
  `role` enum('ADMIN','COMMERCIAL_OFFICER','CUSTOMER','DRIVER','LOGISTICS_OFFICER','MANAGER','PROCUREMENT','QC_INSPECTOR','SUPPLIER') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-06-21  4:25:13
