...
public class MailService {
    ...
    public void sendPasswordResetEmail(String to, String name, String token) throws MessagingException {
                                    ...
                                    <tr>
                                        <td align="left" style="padding:35px 40px 20px 40px;">
                                            <table width="100%%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <span style="font-size:24px; font-weight:800; color:#1e3a8a; letter-spacing:-0.5px;">Courier<span style="color:#2563eb;">BD</span></span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding:0 40px 40px 40px;">
                                            ...
                                            <p style="font-size:15px; line-height:1.6; color:#475569; margin:0 0 24px 0;">
                                                Hello %s, we received an administrative request to reset the account credentials associated with your endpoint node. If you generated this transaction, please initialize your security updates using the secure gateway link below:
                                            </p>
                                            ...
                                            <p style="margin:0; font-size:14px; color:#475569;">
                                                Best regards,<br>
                                                <span style="font-weight:600; color:#1e3a8a;">CourierBD Cyber Security Infrastructure</span>
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="background-color:#f8fafc; padding:30px 40px; border-top:1px solid #f1f5f9;">
                                            ...
                                            <p style="margin:0; color:#94a3b8; font-size:12px;">
                                                © 2026 CourierBD Operations Network. All rights reserved.
                                            </p>
                                        </td>
                                    </tr>
        ...
        SenderGeneralMail(to, "Reset your CourierBD password", body);
    }
...
//Email Verification
     public void sendVerificationEmail(String to, String name, String token) throws MessagingException {
        ...
        String body = """
                                ...
                                <table width="550" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 25px -5px rgba(0,0,0,0.05), 0 8px 10px -6px rgba(0,0,0,0.05); border:1px solid #e2e8f0;">
                                    ...
                                    <tr>
                                        <td style="padding:0 40px 40px 40px;">
                                            ...
                                            <p style="font-size:15px; line-height:1.6; color:#475569; margin:0 0 24px 0;">
                                                Thank you for creating an account with CourierBD—your central node for fast, secure, and reliable supply chain logistics. To initialize your dashboard and activate your administrative access, please verify your endpoint email.
                                            </p>
                                            ...
                                            <p style="margin:0; font-size:14px; color:#475569;">
                                                Best regards,<br>
                                                <span style="font-weight:600; color:#1e3a8a;">CourierBD Global Logistics Team</span>
                                            </p>
                                        </td>
                                    </tr>
         ...
         SenderGeneralMail(to, "Verify your CourierBD account", body);
    }
