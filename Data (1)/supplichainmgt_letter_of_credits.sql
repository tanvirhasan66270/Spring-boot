...
CREATE TABLE `letter_of_credits` (
  ...
  `document_vault_url` varchar(512) DEFAULT NULL,
  ...
  `shipment_inco_terms` varchar(20) NOT NULL,
...
INSERT INTO `letter_of_credits` VALUES (1,0,42000,'2026-06-23 02:07:18.747732','USD',NULL,'2026-11-15','Standard Chartered Bank','2026-09-10','TRN-1782158838748','OPENED',NULL,'PO-1781905064625','Chattogram Port, Bangladesh','Port of Tokyo, Japan','FOB','2026-06-23 02:07:18.747732',1,2);
